...
void RNA_CopiarParaSaida(RedeNeural* Rede, float* VetorSaida) {
...
void RNA_CopiarParaEntrada(RedeNeural* Rede, float* VetorEntrada) {
...
void RNA_CopiarVetorParaCamadas(RedeNeural* Rede, float* Vetor) {
...
void RNA_CriarNeuronio(Neuronio* Neuron, int QuantidadeLigacoes) {
	...
	Neuron->Peso = (float*)malloc(QuantidadeLigacoes * sizeof(float));
