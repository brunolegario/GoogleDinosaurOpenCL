...
int verificarColisao(float X1, float Y1, float Larg1, float Alt1,
...
void AplicarColisao() {
	...
	int IndiceObstaculo;
	float XObstaculo, YObstaculo, AlturaObstaculo, LarguraObstaculo;
	float DinoX, DinoY, DinoLarg, DinoAlt;
